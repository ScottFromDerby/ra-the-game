...
extern const uint16_t DLGTEXT_WelcomeNPCEnjoyingMusic[];
extern const uint16_t DLGTEXT_GrumpyNPC[];
...
extern const uint16_t DLGTEXT_NPCPlaceholder2[];
extern const uint16_t DLGTEXT_NPCPlaceholder3[];
extern const uint16_t DLGTEXT_NPCPlaceholder4[];

extern const char* DLG_IDLOOKUP[];
