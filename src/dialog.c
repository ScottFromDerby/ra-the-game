...
void draw_dialog()
{
    ...
    *DRAW_COLORS = 0x4321;
    ...
    for (int i = 0; i < 20; ++i)
    {
        blitSub(SPRITE_Hud, HALFTILE * i, HALFTILE * 12, HALFTILE, HALFTILE, HALFTILE * 3, HALFTILE * 2, SPRITE_HudWidth, SPRITE_HudFlags);
        blitSub(SPRITE_Hud, HALFTILE * i, HALFTILE * 13, HALFTILE, HALFTILE, HALFTILE * 3, HALFTILE * 2, SPRITE_HudWidth, SPRITE_HudFlags);
        blitSub(SPRITE_Hud, HALFTILE * i, HALFTILE * 14, HALFTILE, HALFTILE, HALFTILE * 3, HALFTILE * 2, SPRITE_HudWidth, SPRITE_HudFlags);
        blitSub(SPRITE_Hud, HALFTILE * i, HALFTILE * 15, HALFTILE, HALFTILE, HALFTILE * 3, HALFTILE * 2, SPRITE_HudWidth, SPRITE_HudFlags);
        blitSub(SPRITE_Hud, HALFTILE * i, HALFTILE * 16, HALFTILE, HALFTILE, HALFTILE * 3, HALFTILE * 2, SPRITE_HudWidth, SPRITE_HudFlags);
        blitSub(SPRITE_Hud, HALFTILE * i, HALFTILE * 17, HALFTILE, HALFTILE, HALFTILE * 3, HALFTILE * 2, SPRITE_HudWidth, SPRITE_HudFlags);
    }

    //  TL
    blitSub(SPRITE_Hud, HALFTILE * 00, HALFTILE * 12, HALFTILE, HALFTILE, HALFTILE * 2, HALFTILE * 2, SPRITE_HudWidth, SPRITE_HudFlags);
    //  TR
    blitSub(SPRITE_Hud, HALFTILE * 19, HALFTILE * 12, HALFTILE, HALFTILE, HALFTILE * 2, HALFTILE * 2, SPRITE_HudWidth, SPRITE_HudFlags | BLIT_FLIP_X);
    //  BL
    blitSub(SPRITE_Hud, HALFTILE * 00, HALFTILE * 17, HALFTILE, HALFTILE, HALFTILE * 2, HALFTILE * 2, SPRITE_HudWidth, SPRITE_HudFlags | BLIT_FLIP_Y);
    //  BR
    blitSub(SPRITE_Hud, HALFTILE * 19, HALFTILE * 17, HALFTILE, HALFTILE, HALFTILE * 2, HALFTILE * 2, SPRITE_HudWidth, SPRITE_HudFlags | BLIT_FLIP_X | BLIT_FLIP_Y);
